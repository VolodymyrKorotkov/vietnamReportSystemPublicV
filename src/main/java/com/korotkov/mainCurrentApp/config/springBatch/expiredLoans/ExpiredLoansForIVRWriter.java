...
public class ExpiredLoansForIVRWriter implements ItemWriter<Object> {
    ...
    public void write(List<? extends Object> list) throws Exception {
        for(Object o : list) {
            ...
            vicidialApiService.addNewLeadExpiredDebt(client.getPhone(), client.getListId(), client.getFullName(),
                    client.getRelationshipName(), "Expired.IVR",
                    client.getDaysOverdue() + " days overdue", String.valueOf(client.getListId()), client.getCurrentDebt().toString(),
