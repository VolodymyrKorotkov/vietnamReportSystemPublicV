...
public class ExportClientDocumentsForCheckInsuranceReport extends AbstractXlsxView {
    @Override
    protected void buildExcelDocument(Map<String, Object> model,
        ...
        ExcelBuildReport.buildExcelExportClientDocsForCheckInsurance(model,workbook);
