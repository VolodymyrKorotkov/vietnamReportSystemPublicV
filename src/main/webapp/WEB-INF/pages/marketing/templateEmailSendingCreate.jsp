...
<mytags:header-template>
    <jsp:attribute name="contentPage">
        <div class="row wrapper border-bottom white-bg page-heading" style="margin-bottom: 30px;">
            <div class="col-lg-7">
                <h2><spring:message code="marketingPage.titleCreatingNewTemplate"/></h2>
                <h6><spring:message code="marketingPage.marketingTitle"/> / <spring:message code="marketingPage.templatesEmailSending"/> / <spring:message code="marketingPage.titleCreatingNewTemplate"/> </h6>
            </div>
            <div class="col-lg-5">
                ...
                <div class="col-lg-6">
                    <div class="form-group">
                        <div class="col-sm-8 col-sm-offset-4">
                            <a class="btn btn-white btn-back" href="/marketing/template-email-sending-list"><spring:message code="common.cancelButton"/></a>
