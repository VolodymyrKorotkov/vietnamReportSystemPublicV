        ...
        <div class="col-lg-12" style="margin-bottom: 20px;">
            <div class="col-sm-6 col-view">
                ...
                <div class="row" style="margin-bottom: 20px;">
                    ...
                    <div class="col-lg-12 view-data-key client-link">
                        <a href="/marketing/template-email-sending-list/${emailSending.templateSendingEmail.id}" target="_blank">
                            <i class="fa fa-link"></i> ${emailSending.templateSendingEmail.title}
                        </a>
                    </div>
                </div>
                ...
                <div class="row" style="margin-bottom: 20px;">
                    ...
                    <div class="col-lg-12 view-data-key">
                        <fmt:parseDate pattern="yyyy-MM-dd'T'HH:mm" var="plannedAt" value="${emailSending.plannedAt}" type="both"/>
                        <fmt:formatDate value="${plannedAt}" pattern="dd.MM.yyyy HH:mm"/>
                    </div>
                </div>
                ...
                <div class="row" style="margin-bottom: 20px;">
                    ...
                    <div class="col-lg-12 view-data-key">
                        <fmt:parseDate pattern="yyyy-MM-dd'T'HH:mm:ss" var="createdAt" value="${emailSending.createdAt}" type="both"/>
                ...
                <div class="row" style="margin-bottom: 20px;">
                    ...
                    <div class="col-lg-12 view-data-key client-link">
                        <a href="/admin/user/${emailSending.createdBy.id}" target="_blank">
                            <i class="fa fa-link"></i> ${emailSending.createdBy.username}
                        </a>
                    </div>
                </div>
            ...
            <div class="col-sm-6 col-view">
                ...
                <div class="row" style="margin-bottom: 20px;">
                    ...
                    <div class="col-lg-12 view-data-key">
                        <c:choose>
                            <c:when test="${emailSending.allActiveClientsWithoutExpiredLoans == true}">
                                ✓
                            </c:when>
                            <c:otherwise>
                                ×
                ...
                <div class="row" style="margin-bottom: 20px;">
                    ...
                    <div class="col-lg-12 view-data-key">
                        <c:choose>
                            <c:when test="${emailSending.repeatPassiveClients == true}">
                                ✓
                            </c:when>
                            <c:otherwise>
                                ×
                ...
                <c:if test="${emailSending.repeatPassiveClients == true}">
                    <div class="row" style="margin-bottom: 20px;">
                        <div class="col-lg-12 view-data-title">
                            <spring:message code="marketingPage.passiveClientsDaysFrom"/>:
                        </div>
                        <div class="col-lg-12 view-data-key">
                            <fmt:formatNumber value="${emailSending.repeatPassiveClientsDaysFrom}" type="number" maxFractionDigits="0"/>
                        </div>
                    </div>
                    ...
                    <div class="row" style="margin-bottom: 20px;">
                        ...
                        <div class="col-lg-12 view-data-key">
                            <fmt:formatNumber value="${emailSending.repeatPassiveClientsDaysTo}" type="number" maxFractionDigits="0"/>
                        </div>
                    </div>
                </c:if>
                ...
                <div class="row" style="margin-bottom: 20px;">
                    ...
                    <div class="col-lg-12 view-data-key">
                        <c:choose>
                            <c:when test="${emailSending.clientsWithExpiredLoan == true}">
                                ✓
                            </c:when>
                            <c:otherwise>
                                ×
                ...
                <c:if test="${emailSending.clientsWithExpiredLoan == true}">
                    <div class="row" style="margin-bottom: 20px;">
                        <div class="col-lg-12 view-data-title">
                            <spring:message code="marketingPage.expiredClientsDaysFrom"/>:
                        </div>
                        <div class="col-lg-12 view-data-key">
                            <fmt:formatNumber value="${emailSending.clientsWithExpiredLoanDaysFrom}" type="number" maxFractionDigits="0"/>
                        </div>
                    </div>
                    ...
                    <div class="row" style="margin-bottom: 20px;">
                        ...
                        <div class="col-lg-12 view-data-key">
                            <fmt:formatNumber value="${emailSending.clientsWithExpiredLoanDaysTo}" type="number" maxFractionDigits="0"/>
                        </div>
                    </div>
                </c:if>
                ...
                <div class="row" style="margin-bottom: 20px;">
                    ...
                    <div class="col-lg-12 view-data-key">
                        <c:choose>
                            <c:when test="${emailSending.registeredClientsWithoutApplications == true}">
                                ✓
                            </c:when>
                            <c:otherwise>
                                ×
                ...
                <c:if test="${emailSending.registeredClientsWithoutApplications == true}">
                    <div class="row" style="margin-bottom: 20px;">
                        <div class="col-lg-12 view-data-title">
                            <spring:message code="marketingPage.clientsWithoutAppDaysFrom"/>:
                        </div>
                        <div class="col-lg-12 view-data-key">
                            <fmt:formatNumber value="${emailSending.registeredClientsWithoutApplicationsDaysFrom}" type="number" maxFractionDigits="0"/>
                        </div>
                    </div>
                    ...
                    <div class="row" style="margin-bottom: 20px;">
                        ...
                        <div class="col-lg-12 view-data-key">
                            <fmt:formatNumber value="${emailSending.registeredClientsWithoutApplicationsDaysTo}" type="number" maxFractionDigits="0"/>
                        </div>
                    </div>
                </c:if>
