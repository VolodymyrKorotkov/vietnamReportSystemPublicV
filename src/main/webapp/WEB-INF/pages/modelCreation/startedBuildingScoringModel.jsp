...
<div class="middle-box text-center animated fadeInDown" style="margin-top: 20px;">
  <h2><spring:message code="scoringCreation.startBuildingHeader"/></h2>
  <h3 class="font-bold"><spring:message code="scoringCreation.startBuildingTitle"/></h3>

  <div class="error-desc">
    <spring:message code="scoringCreation.startBuildingTextDescription"/>
