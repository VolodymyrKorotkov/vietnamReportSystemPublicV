...
<mytags:header-template>
    <jsp:attribute name="contentPage">
        <div class="row wrapper border-bottom white-bg page-heading" style="margin-bottom: 30px;">
            <div class="col-lg-7">
                <h2><spring:message code="${reportName}"/>
                    <c:if test="${not empty additionalInfo}">
                     / ${additionalInfo}
                </c:if></h2>
                <h6><spring:message code="reportsPage.reportsPageTitle"/> / <spring:message code="${reportName}"/></h6>
            </div>
            <div class="col-lg-5">
                ...
                <div class="col-lg-6">
                    <div class="form-group">
                        <div class="col-sm-8 col-sm-offset-4">
                            <button class="btn btn-primary" type="submit"><spring:message code="reportsPage.reportButtonSubmitWithoutInputData"/></button>
                        </div>
                    </div>
                </div>
            </form:form>
