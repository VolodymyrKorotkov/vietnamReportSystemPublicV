...
<mytags:header-template>
    <jsp:attribute name="contentPage">
        <div class="row wrapper border-bottom white-bg page-heading" style="margin-bottom: 30px;">
            <div class="col-lg-7">
                <h2><spring:message code="reportsPage.reportsPageTitleMainDailyReport"/></h2>
                <h6><spring:message code="reportsPage.reportsPageTitle"/> / <spring:message code="reportsPage.reportsPageTitleMainDailyReport"/></h6>
            </div>
            <div class="col-lg-5">
        ...
        <div class="col-lg-12">
            <p class="text-box" style="margin-bottom: 20px;">
                <spring:message code="reportsPage.mainDailyReportWelcomeText"/>
            </p>
