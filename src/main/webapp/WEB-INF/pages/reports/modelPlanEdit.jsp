    ...
    <jsp:attribute name="contentPage">
        <div class="row wrapper border-bottom white-bg page-heading" style="margin-bottom: 30px;">
            <div class="col-lg-7">
                ...
                <h6><spring:message code="reportsPage.reportsPageTitle"/> / <spring:message code="reportsPage.titleModelPlans"/> / <spring:message code="reportsPage.titleModelPlan"/> / <fmt:formatDate value="${date}" pattern="MMMM yyyy"/> / <spring:message code="common.edit"/> </h6>
            </div>
            <div class="col-lg-5">
                <div class="title-action">
                    <a href="/reports/model-plans/${modelPlan.id}" class="btn btn-default">
                ...
                <div class="col-lg-6">
                    <div class="form-group">
                        <div class="col-sm-8 col-sm-offset-4">
                            <a class="btn btn-white btn-back" href="/reports/model-plans/${modelPlan.id}"><spring:message code="common.cancelButton"/></a>
