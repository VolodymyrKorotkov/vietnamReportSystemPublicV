...
<mytags:header-template>
    <jsp:attribute name="contentPage">
        <div class="row wrapper border-bottom white-bg page-heading" style="margin-bottom: 30px;">
            <div class="col-lg-7">
                <h2><spring:message code="usersAccountPage.createNewUserTitle"/></h2>
                <h6><spring:message code="administratorPage.titleAdmin"/> / <spring:message code="usersAccountPage.title"/> / <spring:message code="usersAccountPage.createNewUserTitle"/> </h6>
            </div>
            <div class="col-lg-5">
                ...
                <div class="clearfix">
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <form:input path="username" type="text" cssClass="form-control not-empty required" id="username" required="" maxlength="100"></form:input>
                        ...
                        <div class="form-group">
                            <label for="password" class="col-sm-4 control-label">
                                <spring:message code="usersAccountPage.password"/>:
                            </label>
                            <div class="col-sm-8">
                                <form:input path="password" type="password" cssClass="form-control not-empty required" id="password" required="" maxlength="100"></form:input>
                            </div>
                        </div>

                        <div class="form-group">
                            <label for="passwordConfirm" class="col-sm-4 control-label">
                                <spring:message code="usersAccountPage.passwordConfirmation"/>:
                            </label>
                            <div class="col-sm-8">
                                <form:input path="passwordConfirm" type="password" cssClass="form-control not-empty required" id="passwordConfirm" required="" maxlength="100"></form:input>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <form:select path="userRoleId" type="text" cssClass="form-control not-empty required chosen-select" required="" id="userRole">
                                    <c:set var="userRole" value="${userAccount.userRoleId}"/>
                ...
                <div class="col-lg-6">
                    <div class="form-group">
                        <div class="col-sm-8 col-sm-offset-4">
                            <a class="btn btn-white btn-back" href="/admin/users"><spring:message code="common.cancelButton"/></a>
